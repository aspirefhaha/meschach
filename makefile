...
$(LIST1): $(HBASE)
part1: $(LIST1)
	ar r meschach.a $(LIST1); $(RANLIB) meschach.a

$(LIST2): $(HBASE) matrix2.h
part2: $(LIST2)
	ar r meschach.a $(LIST2); $(RANLIB) meschach.a

$(LIST3): $(HBASE) sparse.h sparse2.h
part3: $(LIST3)
	ar r meschach.a $(LIST3); $(RANLIB) meschach.a

$(ZLIST1): $(HBASDE) zmatrix.h
zpart1: $(ZLIST1)
	ar r meschach.a $(ZLIST1); $(RANLIB) meschach.a

$(ZLIST2): $(HBASE) zmatrix.h zmatrix2.h
zpart2: $(ZLIST2)
	ar r meschach.a $(ZLIST2); $(RANLIB) meschach.a

$(OLDLIST): $(HBASE) sparse.h sparse2.h
oldpart: $(OLDLIST)
	ar r meschach.a $(OLDLIST); $(RANLIB) meschach.a
...
tstpxvec: tstpxvec.o meschach.a
	...
	meschach.a $(LIBS)
xtpilot: xtpilot.o xt_test.o naviguide.o ctlgain.o imudata.o trajectory.o meschach.a
